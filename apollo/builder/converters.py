...
#dict
    ...
    #     for val in self._dynamic.values():
    #         if not isinstance(val, list):
    #             raise ListAsValueRequired(
    #                 "Use a list as a value in dictionary, e.g. {'a': [1,2,3]}"
    #             )

    #     keys = self._dynamic.keys()
    #     if len(keys) > 1:
    #         raise MoreThanOneKeySupplied(
    #             f"Please supply only one key. {keys} keys were given"
    #         )
    ...
    #     for val in self._static.values():
    #         if not isinstance(val, (int, str)):
    #             raise OnlyStringsOrIntsAllow(
    #                 "Only value strings or ints allowed in dictionary, e.g. {'a': '3'}, not {'a': [1,2,3]}"
    #             )
...
#list
# 
# #     def __init__(self, static=None, dynamic=None, delimiter=None):
