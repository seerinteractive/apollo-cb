...
class CloudStorageClient(StorageBase):
    ...
    # def __init__(
    #     self, credentials, project_id, bucket=None, num_retries=10, content_type="json"
    # ):
    ...
    #     """Content-type of data being saved to Cloud Storage

    #     :returns: txt, csv, json, png or jpg
    #     """
    #     return self._content_type

    # @property
    # def num_retries(self,):
    #     """The number of attempts to save to Cloud Storage
